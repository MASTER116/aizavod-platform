...
async def cb_status_agents(callback: CallbackQuery):
    ...
    agents = [
        ("🧠 CEO-агент", "Оркестратор задач", "✅"),
        ("🔍 OpportunityScanner", "Поиск грантов/конкурсов", "✅"),
        ("💡 IdeaGenerator", "Генерация идей заработка", "✅"),
        ("📈 MarketAnalyzer", "Анализ рынка и конкурентов", "✅"),
        ("🔎 FreelanceAgent", "Поиск заказов на фрилансе", "✅"),
        ("💵 PricingAgent", "Оценка проектов и КП", "✅"),
        ("📨 OutreachAgent", "Холодные продажи и лиды", "✅"),
        ("📝 CertifierService", "Консультации по сертификации ТС", "✅"),
        ("📱 InstagramFactory", "Генерация контента", "⚠️ IG login заблокирован"),
    ]
