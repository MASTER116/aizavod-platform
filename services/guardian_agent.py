"""GUARDIAN — антифрод и антиабьюз модуль Zavod-ii.
...
class GuardianAgent(BaseAgent):
    ...
    system_prompt = (
        "Ты — GUARDIAN, модуль безопасности платформы Zavod-ii. "
...
- **Рекомендация**: что предпринять"""
    ...
    async def threat_report(self, period: str = "неделя") -> str:
        ...
        prompt = f"""Составь шаблон отчёта по безопасности Zavod-ii за {period}.
